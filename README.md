# Vice Countdown — Intel Feed

Live news feed for the Vice Countdown iOS app. Edit `news.json` and commit — the app picks it up on next refresh, no app update needed.
